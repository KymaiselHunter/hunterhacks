...
const trackInformation = [
    {
      ...
      trackDescription: '"Winner Winner Hawk Dinner"! This prize celebrates the most outstanding hack across all tracks; the one that rises above in creativity, functionality, design, and impact. Judges may consider how well-rounded your project is, how clearly your team solved a problem, and how polished the final outcome feels.',
    },
    {
      imgTrack: two,
      imgBird: plantbird,
      trackName: 'Best Sustainability Hack',
      trackDescription: '"hawk tuah',
    },
    {
      imgTrack: three,
      imgBird: deibird,
      trackName: 'Best Diversity & Inclusion Hack',
      trackDescription: 'This track honors hacks that center inclusion, representation, and accessibility. Judges may look at how thoughtfully your project considers diverse user needs, how it aims to create equitable outcomes, or how it empowers historically excluded communities.',
    },
    {
      imgTrack: four,
      imgBird: moneybird,
    ...
    },
    {
      ...
      trackDescription: "Projects in this track aim to support well-being, health access, or personal care. Judges may assess how clearly your project identifies a health-related need, how users are supported through your design, and how your solution could make a difference in someone’s daily life."
    },
    {
      imgTrack: six,
      imgBird: techbird,
      trackName: 'Best AI/ML Immersion Hack',
      trackDescription: "This track is for projects that engage meaningfully with AI or machine learning. Judges may consider how well you explain your use of AI/ML, how it contributes to the core functionality of your project, and whether your approach shows curiosity, creativity, and care."
    },
  ];
